...
export default function Stations() {
    ...
    const TABLE_ROWS = [
        ...
        {
            key: 'km_50',
            station: t('STATION_KM_50_NAME'),
            distance_start: '50 km',
            distance_previous: '15.7 km / 700 D+ / 550 D-',
            control_time: t('STATION_KM_50_CONTROL_TIME'),
            location: '-'
        },
        {
            key: 'km_62',
            station: t('STATION_KM_62_NAME'),
            distance_start: '62 km',
            distance_previous: '12 km / 320 D+ / 410 D-',
            control_time: t('STATION_KM_62_CONTROL_TIME'),
            location: '-'
        },
        {
            key: 'raven_chamlak',
            station: t('STATION_RAVEN_CHAMLAK_NAME'),
            distance_start: '69 km',
            distance_previous: '7 km / 290 D+ / 330 D-',
            control_time: t('STATION_RAVEN_CHAMLAK_CONTROL_TIME_88'),
            location: '41.5606389, 25.5184722'
        },
        {
            key: 'zli_trap',
            station: t('STATION_ZLI_TRAP_NAME'),
            distance_start: '78 km',
            distance_previous: '9 km / 430 D+ / 198 D-',
            control_time: t('STATION_ZLI_TRAP_CONTROL_TIME_88'),
            location: '41.5440278, 25.4746667'
        }
    ];

    return <StationsTable tableRows={TABLE_ROWS} />;
}
